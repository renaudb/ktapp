...
export function SectionBrowser({ team, onBack }: SectionBrowserProps) {
  const [selectedSectionIndex, setSelectedSectionIndex] = useState<
    number | null
  >(null);
  const selectedSection =
    selectedSectionIndex === null ? null : team.sections[selectedSectionIndex];
